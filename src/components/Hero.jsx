...
import heroVideo from '../portfolio_assets/hero_video.mp4';
      ...
      <div className="absolute inset-0 z-20 px-6 pb-20 md:pb-[8%] md:px-12 max-w-7xl mx-auto flex flex-col md:flex-row justify-end md:justify-between items-start md:items-end text-left w-full">
        ...
        <div className="flex flex-col items-start text-left max-w-2xl w-full">
          ...
          >
            ...
            <a href={socialLinks.portfolio} className="text-white/60 hover:text-[#ff2a2a]" aria-label="Home">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm7.93 9h-3.05a15.94 15.94 0 00-1.19-5.03A8.03 8.03 0 0119.93 11zM12 4c.84 1.2 2.1 3.85 2.42 7H9.58C9.9 7.85 11.16 5.2 12 4zM8.31 5.97A15.94 15.94 0 007.12 11H4.07a8.03 8.03 0 014.24-5.03zM4.07 13h3.05c.16 1.83.6 3.52 1.19 5.03A8.03 8.03 0 014.07 13zm7.93 7c-.84-1.2-2.1-3.85-2.42-7h4.84c-.32 3.15-1.58 5.8-2.42 7zm3.69-1.97c.59-1.51 1.03-3.2 1.19-5.03h3.05a8.03 8.03 0 01-4.24 5.03z" /></svg>
            </a>
          </div>
